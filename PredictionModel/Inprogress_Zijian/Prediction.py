...
def run(address):
  #'2020 heating the new PTFE line preliminary.prn'
  read_file = pd.read_table(address)
...
s
        ...
        predictions[hazard] = classifier.predict(test_data)

    return predictions

  test_data_realtime = "ts_real_time_prediction2020 heating the new PTFE line prelimihttps://us-prod.asyncgw.teams.microsoft.com/v1/objects/0-cus-d15-e8deb3df19fb081a0a8da0e76caf7686/views/imgpsh_mobile_savenary.txt"
  directory = os.path.dirname(os.path.abspath("__file__"))
  print(directory)
