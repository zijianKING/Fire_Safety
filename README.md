...
5. OR run the *.exe file in folder `Fire_Safety\cpp_ui\build-FireSafety-Desktop_Qt_5_15_2_MinGW_64_bit-Release`. Let me (Cathy) know if anythiny doesn't work for you
